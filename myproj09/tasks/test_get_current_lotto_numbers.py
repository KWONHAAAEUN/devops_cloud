from . import get_current_lotto_numberes
...
def test_get_current_lotto_numbers():
    assert get_current_lotto_numberes.check_available("로또번호 조회")

    expected_html = """988회차 당첨번호 2021.11.06
로또 번호: 2, 13, 20, 30, 31, 41
보너스 번호: 27"""
    assert get_current_lotto_numberes.make_response("", HTML) == expected_html
