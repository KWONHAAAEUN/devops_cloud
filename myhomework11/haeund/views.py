...
from haeund.models import Post

def index(request):
    return render(request,"haeund/index.html")
...
def post_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request,"haeund/post_list.html",{
                  "post_list":qs,})
...
def post_detail(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request,"haeund/post_detail.html",{
        "post":post,
    })
